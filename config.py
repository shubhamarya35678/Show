...
class Config:
    def __init__(self):
        ...
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/GenzBotz")
        ...
        self.PING_IMG = getenv("PING_IMG", "https://files.catbox.moe/uqhjdt.jpg")
        self.START_IMG = getenv("START_IMG", "https://files.catbox.moe/tjux0q.jpg")
